...
public:
    ...
    double  maxDegrees(void)       { return max_deg; }
    void    maxDegrees(double deg) { max_deg = (deg < 0 ? 0:(deg > 360 ? 360:deg)); }
...
private:
    ...
    double     max_deg, min_deg, offset_deg;
